...
{
    public override WeatherForecastViewModel? ReadJson(JsonReader reader, Type objectType, 
        WeatherForecastViewModel? existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
